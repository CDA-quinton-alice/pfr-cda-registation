...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers(HttpMethod.POST, "/construction").authenticated() // seuls les utilisateurs authtifiés ont accès à cette url
				.antMatchers(HttpMethod.GET, "/construction/*").authenticated()
				.antMatchers(HttpMethod.DELETE, "/construction/*").authenticated()
