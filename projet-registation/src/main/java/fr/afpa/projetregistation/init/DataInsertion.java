...
//		DocumentDto doc = new DocumentDto("facture entretien cuve n°3", "facture", achat, achat,
//				"facture qui correspond au dernier entretien de la cuve n°3.",
//				"rien à signaler, fonctionnement de la cuve n°3 ok.");
//		documentService.ajouterDocument(doc);

		DocumentDto docTest = new DocumentDto("nom", "catégorie", achat, achat, "description", "commentaire");
		documentService.ajouterDocument(docTest);
//		documentDao
