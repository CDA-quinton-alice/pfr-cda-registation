...
public class UtilisateurController {
	...
	@PatchMapping("/utilisateur/update")
	public void updateUtilisateur(@RequestBody UtilisateurDto pUtilisateurDto) {
		utilisateurService.updateUtilisateur(pUtilisateurDto);
	}
